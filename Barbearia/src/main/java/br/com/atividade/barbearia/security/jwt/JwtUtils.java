...
public class JwtUtils {
   ...
   public String getUsernameFromJwtToken(String token){
       return Jwts.parserBuilder()
               .setSigningKey(getSignedKey(token))
               .build()
   ...
   public String getUsernameFromRefreshToken(String refreshToken){
       return Jwts.parserBuilder()
               ...
               .build()
               .parseClaimsJws(jwtRefreshSecret).getBody().getSubject();
   }

   public boolean validateJwtToken(String authToken){
       try{
           Jwts.parserBuilder()
                   .setSigningKey(getSignedKey(authToken))
                   .build()
   ...
   public boolean validateRefreshToken(String refreshToken){
       try{
           Jwts.parserBuilder()
                   .setSigningKey(getSignedKey(refreshToken))
                   .build()
    ...
    public List<String> getRolesFromJwtToken(String token) {
        return (List<String>) getClaimsFromToken(token,"roles");
    }
